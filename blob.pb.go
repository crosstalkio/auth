...
func (x *APIKeyBlob) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*APIKeyBlob) ProtoMessage() {}

func (x *APIKeyBlob) ProtoReflect() protoreflect.Message {
	mi := &file_blob_proto_msgTypes[0]
...
// Deprecated: Use APIKeyBlob.ProtoReflect.Descriptor instead.
func (*APIKeyBlob) Descriptor() ([]byte, []int) {
	return file_blob_proto_rawDescGZIP(), []int{0}
}

func (x *APIKeyBlob) GetAlgorithm() string {
	if x != nil {
		return x.Algorithm
	}
	return ""
...
func (x *APIKeyBlob) GetSecret() []byte {
	if x != nil {
		return x.Secret
	}
	return nil
...
func (x *APIKeyBlob) GetECDSAKey() []byte {
	if x != nil {
		return x.ECDSAKey
	}
	return nil
...
var file_blob_proto_rawDesc = []byte{
	,
...
var file_blob_proto_goTypes = []interface{}{
	(*APIKeyBlob)(nil), // 0: auth.APIKeyBlob
}
